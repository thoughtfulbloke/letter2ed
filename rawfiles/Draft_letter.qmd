...
-   That claims of negative New Zealand mortality are underpinned by the "Our World In Data" projection graph using the method of check names all[^2].
...
![baseline](md_figures/figure2.png){fig-alt="Overlong baseline error" fig-align="center"}

Based on the influenza season patterns in recent pre-pandemic years, the Australian Bureau of Statistics (ABS) considers 2013-2019 to give the best baseline[^7]. New Zealand has seen a very similar history in this period to Australia, with the added limitation that incorporating 2011, the year of the Christchurch Earthquake and the residents of the second largest city living in broken housing through the following winter, is a poor influence point to use in a baseline as it is not a re-occurring annual event.

[^7]: Australian Bureau of Statistics. https://www.abs.gov.au/articles/measuring-australias-excess-mortality-during-covid-19-pandemic-until-first-quarter-2023#methodology
...
![Even if all years are before COVID-19, the post-baseline years are above trend](md_figures/figure5.png){fig-alt="Aging increases deaths and the crude death rate" fig-align="center"}
