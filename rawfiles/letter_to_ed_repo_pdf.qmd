...
This is the Github repo for my letter of comment on Gibson's article. The letter references the code data files in the support folder available here. For context, the final draft of the letter is included below, though this final draft may differ slightly from the published version.
